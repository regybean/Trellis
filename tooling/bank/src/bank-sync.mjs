 ...
 * `vendor/bank` branch so its tree is bank@ref filtered down to them and
 ...
 * pinned ref (src/lib/bank-closure.mjs). So a package that gains
 ...
 * reads refs, and never touches `vendor/bank`, the index or the working
 * tree.
 *
 * @param {string} root
