...
export default [
  ...
  // slice's `runtimeEnv` goes through ([ADR 0001](docs/adr/0001-one-env-factory-per-slice.md) §4). It is the same sanctioned
  ...
  // for @acme/env being the central env mechanism ([ADR 0001](docs/adr/0001-one-env-factory-per-slice.md)), so no other
