 ...
 * the port out of the DSN to publish the local container, and provisioning
 * wants the authored value rather than an operator's override. The port is
 * parsed rather than stored twice — a second field would be a drift source.
 */
