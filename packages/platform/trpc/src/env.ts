 ...
 * private `_config` to learn it. Validating it here instead keeps the
 * middleware bodies taking only what they log or decide on, and keeps the read
 * off `process.env` in feature code, where the lint rule rightly bans it.
 *
