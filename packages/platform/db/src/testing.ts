...
// against the values it provisions. `DB_VECTOR_NAME` is `@acme/rag`'s to author,
// so it stays a literal here rather than making this package depend on that one;
// the two agree by convention and the init script defaults to the same name.
