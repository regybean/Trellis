 ...
 * Used by the offline-read tests to prime and then cold-restore a persisted
 ...
 * ingest's provider and the component, as a regression guard for the client
 * pinning nested providers once needed. There is nothing left to guard:
 * `documents.list` carries its persister in its own options now, and a nested
 * client would be a bug in the test rather than a hazard the feature has to
 * survive.
 */
