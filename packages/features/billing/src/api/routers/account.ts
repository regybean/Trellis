 ...
 * absolute Stripe redirect URLs. Absent only in a build that mounts billing
 * without threading it — surface that as a billing error rather than passing
 * `undefined` into `new URL`.
 */
