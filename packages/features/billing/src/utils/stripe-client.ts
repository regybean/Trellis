...
// The Stripe connection, resolved once from this slice's env: `localstripe`
// (dev, against the fake stateful server) or `real`. The SDK host override
// reads `apiBase` off the narrowed `localstripe` variant.
