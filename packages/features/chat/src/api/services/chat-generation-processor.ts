...
// seam the request path does ([ADR 0006](../../../docs/adr/0006-credits-metered-in-the-turn-control-plane.md) / ADR 0010): each app's worker entrypoint
...
// stamps resourceId for Mastra. See [ADR 0004](../../../docs/adr/0004-generation-worker-and-queue.md).
