...
// scaffold — the `NODE_ENV==='test'` `httpLink` MSW seam, the provider
...
// and the 7-day per-query persister. The app owns the `QueryClient`, so there
 ...
 * spread into their options. Carries the persister, `gcTime`, the
