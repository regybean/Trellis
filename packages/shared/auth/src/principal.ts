 ...
 * ([ADR 0003](../docs/adr/0003-framework-agnostic-auth-seam.md)'s amendment).
 * Each app once wrote its own copy of all three; they are collapsed to these.
 *
 ...
 *
 * The role is a **column**, not a JWT claim
 * ([ADR 0001](../docs/adr/0001-self-hosted-better-auth.md)). Nothing here
 * decodes a token.
 */
 ...
 * provider has no source for
 * ([ADR 0001](../docs/adr/0001-self-hosted-better-auth.md)). That leaves this
 * doing one honest job.
 *
