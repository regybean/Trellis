 ...
 * writes. See [ADR 0001](../../../../../docs/adr/0001-self-hosted-better-auth.md) (the self-hosted provider) and [ADR 0002](../../../../../docs/adr/0002-auth-tables-in-a-dedicated-schema.md) (the `auth`
 * schema).
 */
