...
> Amends decision 3 of
> [@acme/rag ADR 0001](../../../rag/docs/adr/0001-mastra-rag-and-memory.md)
> ("Bedrock via an AI-SDK provider instance"): the AI-SDK-instance approach
> stands, but the instance is now produced by `@acme/models`, one of three
> providers, not constructed in `@acme/rag`.
