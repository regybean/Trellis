 ...
 * primitive — and has no tier to gate on, so it names no billing type. This is
 * the first `shared` package to own a tRPC router: the platform stays
 * router-free and React-free.
 */
