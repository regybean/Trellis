...
across the rewrite, because they assert rendered DOM rather than form
internals. That is the evidence the seam sits in the right place, and the reason
a future swap stays cheap.
