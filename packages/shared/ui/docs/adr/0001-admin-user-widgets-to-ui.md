...
> Refines [ADR 0011](../../../../../docs/adr/0011-remove-compositions-layer.md)
> for these two files only. Amended by #239 (the user shape is Better Auth's,
> adapted once) and #225 (the widgets render Better Auth's columns directly; the
> role mutation is one typed callback).
