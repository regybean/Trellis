...
// route handler gets it (ADR 0006) — so a worker error refunds the same Credit
// ledger the request path charged. It cannot be a second provider: there is only
// one, and lint keeps the factory out of this file.
...
logger.info(
  { queue: QUEUE_NAMES.INGEST, app: 'nextjs' },
