 ...
 * (@acme/env ADR 0003) — a deploy that inherited `localhost:3000` would issue auth
 * callbacks nobody can follow. Server-only: the browser never needs it, because `createAuthClient` is
