...
live in its `docs/adr/` and are listed per row below. Where an ADR goes, how it
is numbered and what its status may say are in
[docs/agents/domain.md](docs/agents/domain.md#where-an-adr-lives).

| ADR                                                                                        | Decision                                                                                                                          |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------- |
| [`0001`](tooling/secrets-sync/docs/adr/0001-pluggable-secrets-sync.md)                     | Pluggable secrets sync with `.env.example` as the contract.                                                                       |
| [`0003`](packages/shared/auth/docs/adr/0003-framework-agnostic-auth-seam.md)               | Auth is injected into the tRPC context; the app owns the session resolver.                                                        |
| [`0006`](packages/platform/entitlements/docs/adr/0001-entitlements-injection-seam.md)      | Billing is injected into the tRPC context as an `EntitlementsProvider`.                                                           |
...
| [`0009`](tooling/workspace-graph/docs/adr/0001-graph-derived-dev-infra.md)                 | `pnpm dev` derives the infra it starts from the dependency graph.                                                                 |
...
| [`0017`](tooling/test-utils/docs/adr/0001-test-infra-owned-by-infra-package.md)            | A suite declares its test infra explicitly; the infra package owns the descriptor.                                                |
...
| [`0021`](tooling/test-utils/docs/adr/0002-test-schema-provisioning-db-push.md)             | Testcontainer schemas are provisioned by the app's `drizzle-kit push --force`.                                                    |
| [`0023`](packages/platform/telemetry/docs/adr/0001-ambient-telemetry-no-context-object.md) | Telemetry is ambient, never threaded through tRPC context.                                                                        |
...
| ---------------------------------- | ---------------------------------------------------------- | ---------------------------------------------------------- | ------------------------------------------------------ | ------------------------------ |
| `packages/platform/trpc/`          | [`CONTEXT.md`](packages/platform/trpc/CONTEXT.md)          | [`ADAPTER.md`](packages/platform/trpc/ADAPTER.md)          | [`docs/adr/`](packages/platform/trpc/docs/adr/)        | `0003`, `0006`, `0010`, `0023` |
...
| `packages/platform/queue/`         | [`CONTEXT.md`](packages/platform/queue/CONTEXT.md)         | [`ADAPTER.md`](packages/platform/queue/ADAPTER.md)         | —                                                      | `0008`                         |
...
| `packages/shared/auth/`            | [`CONTEXT.md`](packages/shared/auth/CONTEXT.md)            | [`ADAPTER.md`](packages/shared/auth/ADAPTER.md)            | [`docs/adr/`](packages/shared/auth/docs/adr/)          | `0003`, `0010`, `0021`         |
| `packages/shared/hooks/`           | [`CONTEXT.md`](packages/shared/hooks/CONTEXT.md)           | [`ADAPTER.md`](packages/shared/hooks/ADAPTER.md)           | [`docs/adr/`](packages/shared/hooks/docs/adr/)         | `0003`, `0010`, `0036`         |
...
| `packages/shared/notifications/`   | [`CONTEXT.md`](packages/shared/notifications/CONTEXT.md)   | [`ADAPTER.md`](packages/shared/notifications/ADAPTER.md)   | [`docs/adr/`](packages/shared/notifications/docs/adr/) | `0010`, `0036`                 |
| `packages/shared/ui/`              | —                                                          | [`ADAPTER.md`](packages/shared/ui/ADAPTER.md)              | [`docs/adr/`](packages/shared/ui/docs/adr/)            | `0011`, `0018`                 |
| `packages/features/billing/`       | [`CONTEXT.md`](packages/features/billing/CONTEXT.md)       | [`ADAPTER.md`](packages/features/billing/ADAPTER.md)       | [`docs/adr/`](packages/features/billing/docs/adr/)     | `0006`, `0036`                 |
