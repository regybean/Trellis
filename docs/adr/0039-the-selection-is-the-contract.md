...
This implements [#267](https://github.com/regybean/Trellis/issues/267), and
amends in part [ADR 0037](0037-vendored-git-subset-three-way-merge.md) — the
mechanism stands unchanged; what a manifest holds and what `bank.paths.json`
lists do not.
