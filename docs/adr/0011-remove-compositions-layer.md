...
**Status:** amended by ../../packages/shared/ui/docs/adr/0001-admin-user-widgets-to-ui.md
...
[@acme/ui ADR 0001](../../packages/shared/ui/docs/adr/0001-admin-user-widgets-to-ui.md)
later applied this escape hatch: the
