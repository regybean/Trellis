...
- **AI-native** — a glossary `CONTEXT.md` per package, ADRs living with what they govern ([the rules](agents/domain.md)), and an [agent workflow](agents/) (planning + parallel isolated build agents). See below.
