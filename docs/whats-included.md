...
| [`@acme/auth`](../packages/shared/auth/)               | Self-hosted [Better Auth](adr/0034-self-hosted-better-auth.md) behind a **framework-agnostic seam** — the app resolves the request into context, the feature never imports an auth SDK. See [ADR 0003 (auth seam)](adr/0003-framework-agnostic-auth-seam.md). | ✅     |
