...
[@acme/auth ADR 0003](../../packages/shared/auth/docs/adr/0003-framework-agnostic-auth-seam.md),
and `apps/docs/adr/` for how a no-auth deployment is put together. Which features
want more than `BaseContext` is theirs to say, not the platform's
([@acme/entitlements ADR 0001](../../packages/platform/entitlements/docs/adr/0001-entitlements-injection-seam.md)).
